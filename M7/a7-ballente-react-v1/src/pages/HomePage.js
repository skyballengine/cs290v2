...
function HomePage() {
    return (
            <div>
                ...
                <a href="index.html#article1">Web Servers</a>
                <a href="index.html#article2">Frontend Design</a>
                <a href="index.html#article3">Javascript</a>
                <a href="index.html#article4">DOM Changes</a>
                </nav>
                <article id="article1">
                    <h3>Web Servers</h3>
                    <p>
                        Within the language of websites and servers, <strong>index.html</strong>
                        is the
